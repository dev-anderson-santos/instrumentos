...
<link href="css/sopro.css" rel="stylesheet" type="text/css" />
</head>
...
<div id="pagina">
  ...
  <div id="conteudo">
    ...
    <div class="catSopro"><a href="index.html">Home</a> ›› Sopro</div><!-- fim catSopro -->
		<div id="v1">
              <div class="camada1">
              ...
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 1.899,00</p>
              <p align="left" style="color:#000;font-size:14px">10x de R$ 189,90 sem juros ou R$ 1.709,10 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim do v1 -->
   	  <div id="v2">
      		  <div class="camada1">
                <img src="img/sopro/s2.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Flauta Doce Soprano Yamaha Yrs23g Germânica
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 25,00</p>
              <p align="left" style="color:#000;font-size:14px">ou R$ 224,10 no boleto
              </div><!-- fim do preco -->
      	</div><!-- fim do v2 -->
      <div id="v3">
        	  <div class="camada1">
                <img src="img/sopro/s3.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Trompete Michael Wtrm36 Laqueado
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 747,00</p>
              <p align="left" style="color:#000;font-size:14px">10x de R$ 74,70 sem juros ou R$ 672,30 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim do v3 -->
        <div id="v4">
        	  <div class="camada1">
                <img src="img/sopro/s4.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Sax Tenor Michael Wtsm47
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 2.675,00</p>
              <p align="left" style="color:#000;font-size:14px">10x de R$ 267,50 sem juros ou R$ 2.407,50 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim da v4 -->
        <div id="v5">
        	  <div class="camada1">
                <img src="img/sopro/s5.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Trombone Jupiter Jsl232l Com Vara
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 2.199,00</p>
              <p align="left" style="color:#000;font-size:14px">10x de R$ 219,90 sem juros ou R$ 1.979,10 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim do v5 -->
        <div id="v6">
        	  <div class="camada1">
                <img src="img/sopro/s6.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Flauta Doce Contralto Yamaha Yra302biii
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 170,00</p>
              <p align="left" style="color:#000;font-size:14px">3x de R$ 56,67 sem juros ou R$ 153,00 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim do v6 -->
