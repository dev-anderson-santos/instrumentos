...
<div id="pagina">
  ...
  <div id="conteudo">
    ...
    <div class="catViolao"><a href="index.html">Home</a> ›› Violão Ac&uacute;stico Giannini S14 A&ccedil;o - Preto</div><!-- fim catViolao -->
        ...
        <div id="dados_compra">
        	Violão Ac&uacute;stico Giannini S14 A&ccedil;o - Preto
            
            <div class="preco">
            	<p align="left" style="color:#930;font-size:18px">por R$ 199,00</p>
            	<p align="left" style="color:#000;font-size:14px"><strong>3x</strong> de R$ 66,33 sem juros ou <strong><font color="#FF6600">R$ 179,10</font></strong> à vista no boleto
                <div class="comprar">
        ...
        <div id="veja">
          ...
          <div id="v2">
                  <div class="camada1">
                    <img src="img/violao/v2.jpg" width = "100px" height = "100px"/>
                  </div><!-- fim da camada1 -->
                  <div class="info">
