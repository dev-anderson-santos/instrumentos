...
<link href="css/violao.css" rel="stylesheet" type="text/css" />
</head>
...
<div id="pagina">
  ...
  <div id="conteudo">
    ...
    <div class="catViolao"><a href="index.html">Home</a> ›› Violão</div><!-- fim catViolao -->
		<div id="v1">
              <div class="camada1">
              ...
              <p align="left" style="color:#000;font-size:14px">3x de R$ 66,33 sem juros ou R$ 179,10 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim do v1 -->
   	  <div id="v2">
      		  <div class="camada1">
              ...
              <p align="left" style="color:#000;font-size:14px">4x de R$ 62,25 sem juros ou R$ 224,10 no boleto
              </div><!-- fim do preco -->
      	</div><!-- fim do v2 -->
      <div id="v3">
        	  <div class="camada1">
                <img src="img/violao/v3.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Violão Acústico Giannini N14 Nylon - Natural
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 199,00</p>
              <p align="left" style="color:#000;font-size:14px">3x de R$ 66,33 sem juros ou R$ 179,10 no boleto
        ...
        <div id="v4">
        	  <div class="camada1">
                <img src="img/violao/v4.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Violão Elétrico Eagle Gl36 Stnt Ativo Com Cordas de Aço
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 516,00</p>
              <p align="left" style="color:#000;font-size:14px">10x de R$ 51,60 sem juros ou R$ 464,40 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim da v4 -->
        <div id="v5">
        	  <div class="camada1">
                <img src="img/violao/v5.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Violão Elétrico Takamine Ef340sc Natural - Cordas de Aço
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 4.990,00</p>
              <p align="left" style="color:#000;font-size:14px">10x de R$ 499,90 sem juros ou R$ 4491,00 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim do v5 -->
        <div id="v6">
        	  <div class="camada1">
                <img src="img/violao/v6.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Violão Folk Michael Vm921dt St Natural Fosco Com Cordas de Aço
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 625,00</p>
              <p align="left" style="color:#000;font-size:14px">10x de R$ 62,50 sem juros ou R$ 562,50 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim do v6 -->
        <div id="v7">
        	  <div class="camada1">
                <img src="img/violao/v7.jpg" width = "200px" height = "200px"/>
              </div><!-- fim da camada1 -->
              <div class="info">
                Violão Elétrico Di Giorgio Talent 01 Nylon
              </div><!-- fim da info -->
              <div class="preco">
              <p align="left" style="color:#930;font-size:18px">por R$ 639,00</p>
              <p align="left" style="color:#000;font-size:14px">10x de R$ 63,90 sem juros ou R$ 575,10 no boleto
              </div><!-- fim do preco -->
        </div><!-- fim do v7 -->
