...
<script language="javascript">
	function add(){
		clica.result.value = parseInt(clica.result.value) +1;
	}
</script>
...
<div id="pagina">
  <div id="topo">
  	...
  	<div class="contaPedidos">
        ...
        <input type="text" name="result" value="0" size="2"/>)</a>
        </form>)</a>
  ...
  <div id="conteudo">
    ...
    <div class="catViolao"><a href="index.html">Home</a> ›› Guitarra Ibanez Rg2550z Prestige</div><!-- fim catViolao -->
		<div id="v1_compra">
              <div class="camada_compra">
                <a href="#"><em><img src="img/guitarra/g1_grande.jpg" width = "390px" height = "415px"/></em>
                <span>
                <img src="img/guitarra/g1_grande.jpg" width = "780px" height = "830px"/>
                </span>
                </a>
              </div><!-- fim da camada_compra -->
              
        </div><!-- fim do v1_compra -->
        <div id="dados_compra">
        	Guitarra Ibanez Rg2550z Prestige
            
            <div class="preco">
            	<p align="left" style="color:#930;font-size:18px">por R$ 5.249,00</p>
            	<p align="left" style="color:#000;font-size:14px"><strong>10x</strong> sem juros de R$ 524,90 ou <strong><font color="#FF6600">R$ 524,90</font></strong> à vista no boleto
                <div class="comprar">
                	<a href="#" onclick='add();'><img src="img/comprar.png" /> </a>                    
                </div>
            </div><!-- fim do preco -->
         </div><!-- fim do dados_compra -->
        
        <div id="veja">
       	  <div class="catVeja">Veja tamb&eacute;m</div><!-- fim catVeja -->
        
          <div id="v2">
                  <div class="camada1">
                    <img src="img/guitarra/g2.jpg" width = "100px" height = "100px"/>
                  </div><!-- fim da camada1 -->
                  <div class="info">
          ...
          <div id="v3">
                  <div class="camada1">
                    <img src="img/guitarra/g3.jpg" width = "100px" height = "100px"/>
                  </div><!-- fim da camada1 -->
                  <div class="info">
            ...
            <div id="v4">
                  <div class="camada1">
                    <img src="img/guitarra/g4.jpg" width = "100px" height = "100px"/>
                  </div><!-- fim da camada1 -->
                  <div class="info">
            ...
            <div id="v5">
                  <div class="camada1">
                    <img src="img/guitarra/g5.jpg" width = "100px" height = "100px"/>
                  </div><!-- fim da camada1 -->
                  <div class="info">
            ...
            <div id="v6">
                  <div class="camada1">
                    <img src="img/guitarra/g6.jpg" width = "100px" height = "100px"/>
                  </div><!-- fim da camada1 -->
                  <div class="info">
  ...
  <div id="rodape">
    	<img src="img/cartoes.jpg" alt="Formas de pagamentos" />
    <hr color="#CCCCCC" />
